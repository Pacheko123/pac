...
<!--sa poip up-->
<link href="image/facebox.css" media="screen" rel="stylesheet" type="text/css" />
   <script src="image/jquery.js" type="text/javascript"></script>
  <script src="image/facebox.js" type="text/javascript"></script>
...
<!-- HIDDEN COLOR CHANGER -->
  	...
  	<!--LOGO-->
	<div class="grid_8" id="logo">PACHEKO INC ADMINISTRATION</div>
    <div class="grid_8">
<!-- USER TOOLS START -->
		...
		<div class="portlet">
			...
			<table cellpadding="1" cellspacing="1" id="resultTable">
				...
				while($row = mysqli_fetch_array($result)){
						...
						echo '<td><div align="center"><a href="#" id="'.$row['id'].'" class="repbutton" title="Click To Delete">reply</a></div></td>';
						echo '</tr>';
					}
				?>
				</tbody>
...
//Built a url to send
var info = 'id=' + del_id;
 if(confirm("Sure to delete this update? There is NO undo!")){
 $.ajax({
   type: "GET",
